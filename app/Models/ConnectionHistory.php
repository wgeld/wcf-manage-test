...
class ConnectionHistory extends Pivot
{
    protected $connection = 'sqlcisprod';

    protected $table = 'UM00300H';
    ...
    protected $maps = [
        ...
        'umTransferDate'            => 'transfer_date',
        'umTransferTime'            => 'transfer_time',
        'UMCONNMULT'               => 'connection_multiplier',
        ...
        'umAlternateConnectStatus'  => 'alternate_connection_status'
    ];
    ...
    {
        return $this->belongsTo(Connection::class, 'umLocationID','umLocationID');
    }
    ...
    {
        return trim($this->attributes['umTransferDate']);
    }
    public function getTransferTimeAttribute()
    {
        return trim($this->attributes['umTransferTime']);
    }
